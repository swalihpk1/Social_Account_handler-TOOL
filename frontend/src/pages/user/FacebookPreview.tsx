...
const FacebookPreview: React.FC<FacebookPreviewProps> = ({ text, facebookAccount, selectedLocalImage, selectedLibraryImage, shortenedLinks }) => {
    return (
        <>
            ...
            <Stack sx={{ background: 'white', mx: '1.5rem', borderRadius: '6px', pt: 1 }}>
                <Stack direction='row' sx={{ px: 1, display: 'flex', justifyContent: 'space-between' }}>
                    <Stack direction='row' gap={.5} sx={{ alignItems: 'center' }} >
                        ...
                        <Stack>
                            <Typography sx={{ fontSize: 'small' }}>{facebookAccount.name}</Typography>
